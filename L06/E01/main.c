...
void ricava_playlist(Amico amici[], int n_amici);
void princ_molt(int pos, Amico amici[], char* sol[], int n);
...
void ricava_playlist(Amico amici[], int n_amici) {
    char* sol[n_amici];
    princ_molt(0, amici, sol, n_amici);
}
